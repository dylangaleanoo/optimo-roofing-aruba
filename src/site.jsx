...
export default function RoofingSite() {
  ...
  const LICENSE = "";
  const LOGO = "/assets/optimo-logo.png"; // put your logo at public/assets/optimo-logo.png
  const BRAND = "#0A326E";
  ...
  return (
    <div className="min-h-screen bg-neutral-50 text-neutral-900" style={{ "--brand": BRAND, "--brand-gray": BRAND_GRAY }}>
      ...
      <header className="sticky top-0 z-40 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 border-b">
        <div className="mx-auto max-w-7xl px-4 py-3 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <a href="#contact" className="inline-flex items-center rounded-xl border px-4 py-2 text-sm font-semibold bg-[color:var(--brand)] hover:opacity-90 text-white shadow-sm">
              Free Estimate
            </a>
          </nav>
        ...
        {mobileOpen && (
          <div className="md:hidden border-t bg-white">
            <div className="px-4 py-3 space-y-2">
              ...
              <a href="#contact" className="inline-flex items-center rounded-xl border px-4 py-2 text-sm font-semibold bg-[color:var(--brand)] text-white hover:opacity-90" onClick={() => setMobileOpen(false)}>
                Free Estimate
              </a>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 py-24 relative">
          <div className="max-w-2xl">
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3">
              <a href="#contact" className="inline-flex items-center rounded-xl border px-5 py-3 text-base font-semibold bg-[color:var(--brand)] hover:opacity-90 text-white shadow">
                Get a Free Estimate
              </a>
      ...
      {/* Aruba banner (simple, no external icon deps) */}
      <section className="bg-[color:var(--brand)] text-white py-6 text-center">
      ...
      <section id="why" className="bg-neutral-900 text-neutral-50">
        <div className="mx-auto max-w-7xl px-4 py-20 grid lg:grid-cols-2 gap-14">
          <div>
            ...
            <div className="mt-8">
              <a href="#contact" className="inline-flex items-center rounded-xl border border-neutral-700 px-5 py-3 text-base font-semibold bg-[color:var(--brand)] text-white hover:opacity-90">
      ...
      <section id="gallery" className="mx-auto max-w-7xl px-4 py-20">
        <div className="flex items-end justify-between">
          ...
          <a href="#contact" className="hidden sm:inline-flex rounded-xl border px-4 py-2 font-semibold text-[color:var(--brand)] border-[color:var(--brand)]">Get a Quote</a>
        </div>
      ...
      {/* Service Area (Financing section removed) */}
      <section className="mx-auto max-w-7xl px-4 py-20">
        <div className="rounded-2xl border p-6 bg-white shadow-sm max-w-xl">
          <h3 className="text-xl font-bold">Service Area</h3>
          <p className="mt-2 text-neutral-700">We serve all of Aruba.</p>
          <div className="mt-4 aspect-video w-full rounded-xl overflow-hidden bg-neutral-200 grid place-items-center text-neutral-600">
          ...
          <div className="rounded-2xl bg-white text-neutral-900 p-6 shadow-lg">
            {!submitted ? (
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button type="submit" className="w-full rounded-xl bg-[color:var(--brand)] hover:opacity-90 px-4 py-3 font-semibold text-white">
                  Send Request
                </button>
                <p className="text-xs text-neutral-500">By submitting, you agree to be contacted by {COMPANY}. Your info is kept private.</p>
              </form>
            ) : (
